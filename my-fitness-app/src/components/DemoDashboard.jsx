...
function DemoDashboard() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 space-y-6">
        <h1 className="text-3xl font-bold text-center text-blue-700">🚀 健身紀錄系統 Demo</h1>
        {/* 系統特色介紹 */}
        <div className="bg-white rounded-xl shadow p-6 space-y-4 mt-12 border border-gray-200">
        <h2 className="text-2xl font-bold">🔍 系統特色 Highlights</h2>
        <ul className="list-disc list-inside space-y-1 text-gray-700">
            <li>📊 訓練資料可視化，幫助追蹤每週進度與成長趨勢</li>
            <li>⚙️ 採用分層架構（Controller / DTO / Exception / Repository）強化維護性</li>
            <li>🛡️ 支援 JWT 驗證機制，確保資料安全與登入狀態</li>
        ...
        <section className="space-y-2">
            <h2 className="text-xl font-semibold text-gray-800">🛠️ 使用技術</h2>
