...
//         CreateSessionRequestDTO requestDTO = new CreateSessionRequestDTO("2025-04-28", "testNote", null);
...
//         List<WorkoutAllSessionsDTO> result = workoutSessionService.getAllSession(user.getId());
